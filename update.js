...
function myVis(data) {
  ...
  gitHole.text("View D3 code at https://github.com/jcwhiting/FoodInteractive")

//Mike Bostock's text wrap function, which is either not working or I am executing it
//improperly. Either way very frustrating and if he updates d3 all the time you'd think
//that he would make SVG text with better formatting. 
